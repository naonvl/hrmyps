...
<title>@if(Auth::user()->type == 'super admin')  {{config('app.name', 'Hrm YPS Saas')}} @else {{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Hrm YPS SaaS')}} @endif</title>
